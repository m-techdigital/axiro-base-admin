import { Card, Checkbox, Input, InputNumber, Select, message } from 'antd'
import { useEffect, useState } from 'react'
import { useNavigate, useParams } from 'react-router-dom'
import { BaseForm, BaseFormFooter, BasePageHeader } from '@/components/base'
import {
    GAME_OPTIONS,
...
export default function ProductForm() {
    ...
    return (
        <div className="page">
            <BasePageHeader title={id ? 'Cập nhật sản phẩm' : 'Tạo sản phẩm'} />
