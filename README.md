...
## Shared foundation selection

BaseView and the parent field-rendering contract are now adopted by transaction detail with source-closure gates. See `docs/canonical/parent-foundation.md`.
