...
Legacy extraction baseline was single administrator only. The current Mini baseline is one admin with many marketplace customers and includes bounded customer/product/transaction operations, media/document handling and audit/history surfaces.
